...
MAP_CONFIGS = {
    "circle": {
        ...
        "policy_prefix": "[equilibrium][circle]agent0_",
    ...
    "counter": {
        "map_type": "counter",
        "grid_dim": [5, 8],
        "policy_pool_dir": os.path.join(current_dir, "final_policy_pool_counter_coplay2"),
        "embedding_csv": os.path.join(current_dir, "tsnt_counter_coplay2.csv"),
