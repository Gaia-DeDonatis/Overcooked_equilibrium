...
# Show data only up to this episode.
# This excludes the final episode from the heatmap/plot if the final episode is E17.
...
def filter_episodes_up_to(
    ...
    This is useful when the final episode is expected to go worse and should not
    influence the heatmap, worst-episode selection, or plotted representation.
    """
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Default: 16, so the final episode is excluded from the heatmap."
        ),
    )
