...
class OverviewAnalysis(Analysis):
    ...
    def compute(
        ...
        # TEMPORARILY DISABLED: CrossValidationPlot has a bug with read-only arrays
        # diagnostics_group = DiagnosticAnalysis().compute_or_error_card(
        #     experiment=experiment,
        #     generation_strategy=generation_strategy,
        #     adapter=adapter,
        # )
        diagnostics_group = None
...
def evaluate(parameter):
    # This is a place holder. Your actual human feedback will take the place of this function. But this is there for debugging purposes
    # what we just need is a trial_idx and utility score mapping. 
    s = 0
