...
class Overcooked_MA_lowuncertainty_ban_get_plate(Overcooked):
    ...
    # def _computeLowLevelActions(self, macro_actions):
        ...
        for idx, agent in enumerate(self.agent):
            ...
            if self.macroAgent[idx].cur_macro_action_done:
                ...
                if self.macroActionName[macro_actions[idx]] == "get plate 1" or self.macroActionName[macro_actions[idx]] == "get plate 2":
                    ...
                    if idx == 1:
                        ...
                        if target_x1 == counter_x_in_this_map and target_x2 != counter_x_in_this_map:
                            which_lettuce = 5
                        if target_x2 == counter_x_in_this_map and target_x1 != counter_x_in_this_map:
                            which_lettuce = 4
                        if target_x1 == counter_x_in_this_map and target_x2 == counter_x_in_this_map:
                            # print('都在counter上')
                            which_lettuce = 0
            ...
            # 如果mac action是chop
                ...
                tocounter1 = self.shortest_path_through_zeros(agent.pomap, agent.x, agent.y, 10, 12)
                tocounter2 = self.shortest_path_through_zeros(agent.pomap, agent.x, agent.y, 10, 13)
