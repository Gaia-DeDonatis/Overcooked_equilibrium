...
class Overcooked_MA_ban_get_plate(Overcooked):
    ...
    # def _computeLowLevelActions(self, macro_actions):
        ...
        for idx, agent in enumerate(self.agent):
            ...
            # 如果mac action是chop
                ...
                tocounter1 = self.shortest_path_through_zeros(agent.pomap, agent.x, agent.y, 4, 12)
                tocounter2 = self.shortest_path_through_zeros(agent.pomap, agent.x, agent.y, 4, 13)
