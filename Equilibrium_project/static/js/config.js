...
CONFIG.PHASE_STRESS_END = CONFIG.PHASE_BO_END + CONFIG.EPISODES_STRESS;

// Total episodes shown to participants
CONFIG.PHASE_REPLAY_END = CONFIG.PHASE_STRESS_END + CONFIG.EPISODES_REPLAY_OPTIMAL;
CONFIG.TOTAL_EPISODES = CONFIG.PHASE_REPLAY_END;// Phase boundaries used by controller.js
